...
public class PostsDetailsBean extends BaseBean {

    private PostDetailBeanOuter data;

    public PostDetailBeanOuter getData() {
        return data;
    }

    public static class  PostDetailBeanOuter{
        /**
         * isUpdated : false
