...
public enum EnumTAB {
    ...
    TAB3(R.id.rb_tab_3, R.drawable.tab_3, "直播预告", new CollegeFragment()),
    TAB4(R.id.rb_tab_4, R.drawable.tab_4, "话题管理", new CollegeFragment()),
    TAB5(R.id.rb_tab_5, R.drawable.tab_5, "人员管理", new CollegeFragment());
