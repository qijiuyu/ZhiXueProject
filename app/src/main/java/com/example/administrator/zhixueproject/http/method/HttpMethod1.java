...
public class HttpMethod1  extends BaseRequst {
     ...
     * @param handler
     */
    public static void sendCode(String mobile,String type,final Handler handler) {
        Map<String, String> map = new HashMap<>();
        map.put("mobile",mobile);
        map.put("type",type);
        Http.getRetrofit().create(HttpApi1.class).sendCode(map).enqueue(new Callback<BaseBean>() {
