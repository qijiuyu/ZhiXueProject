...
public class PlaybackDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        ColorFilter filter = new LightingColorFilter
                (getResources().getColor(R.color.color_40c5f1), getResources().getColor(R.color.color_40c5f1));
        ...
        iv_record_play = (ImageView) view.findViewById(R.id.iv_record_play);
...
//        mFileNameTextView.setText(item.getName());
    ...
    private void pausePlaying() {
        iv_record_play.setImageResource(R.mipmap.ic_media_play);
        mHandler.removeCallbacks(mRunnable);
        mMediaPlayer.pause();
    }
